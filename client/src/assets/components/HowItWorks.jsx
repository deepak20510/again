      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative">
            ...
            <div className="bg-linear-to-br from-amber-100 to-orange-100 rounded-3xl p-6 relative overflow-hidden">
              {/* Background decorative elements */}
              <div className="absolute top-0 right-0 w-64 h-64 bg-orange-200/30 rounded-full blur-2xl"></div>
              <div className="absolute bottom-0 left-0 w-48 h-48 bg-yellow-200/40 rounded-full blur-xl"></div>
            ...
            <div className="absolute -bottom-8 -right-4 z-20 bg-indigo-600 rounded-2xl p-4 shadow-2xl text-white w-64 h-28 ">
              <h4 className="font-bold text-lg mb-1">Ready to scale?</h4>
          ...
          <div>
            ...
            <div className="mt-10">
              <button
                ...
                className="w-40 bg-gray-900 hover:bg-gray-800 hover:scale-105 hover:shadow-lg text-white px-4 py-3 rounded-xl text-sm font-semibold transition-all duration-300 ease-out"
              >
                Get Started Now
              </button>
            </div>
